...
def calculate_ellipsoidal_areas(ds, res=0.25):
    # Initialize the Geod object with the WGS84 ellipsoid - DJF: Moved into function
...
def calc_hourly_flux(MAXSS_working_directory,output_base,netcdf_output_root,runs,MAXSS_regions,storms_to_skip):
    # --- MAIN LOOP ---
